...
import { formImage } from "@/lib/import-assets";
    ...
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      ...
      <Card className="overflow-hidden py-0">
        <CardContent className="grid p-0 md:grid-cols-2">
            ...
            <div className="flex flex-col gap-6">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-balance text-muted-foreground">
                  Inicia sesion en tu cuenta de Turnia
                </p>
              </div>
              ...
              <div className="grid gap-2">
                <div className="flex items-center">
                  ...
                  <a
                    href="#"
                    className="ml-auto text-slate-500 text-xs underline-offset-2 hover:underline"
                  >
          ...
          <div className="relative hidden md:block bg-muted h-full w-full">
            <img
              src={formImage}
              alt="Image"
